$(function () {
    ...
    let infoUrl = '/o2o/shopadmin/getproductbyid?productId=' + productId;

    let categoryUrl = '/o2o/shopadmin/getproductcategorylist';
    let productPostUrl = '/o2o/shopadmin/modifyproduct';
            ...
            function (data) {
                if (data.success) {
                    ...
                    optionArr.map(function (item, index) {
                        let isSelected = optionSelected === item.productCategoryId?'selected':'';
    ...
    $('.detail-img-div').on('change', '.detail-img:last-child', function () {
        if ($('.detail-img').length < 6) {
            $('#detail-img').append('<input type="file" class="detail-img form-control">');
        }
    });
